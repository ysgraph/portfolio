...
import faceLogo from '../images/logo.svg'
        ...
        <div className={styles.fixedNav}>
          ...
          >
            <div className={styles.logo}>
              ...
              >
                <img src={faceLogo} alt="Design Layout Icon" className={styles.detailIcon} />
              </Link>
            </div>
      ...
      <AnimatePresence>
        {navOpen === true && (
          <motion.nav
            ...
            exit="exit"
          >
            <div className={styles.backdrop} onClick={updateNav}></div>
            <motion.div
